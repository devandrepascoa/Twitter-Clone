...
let ManagementEditComponent = class ManagementEditComponent {
    ...
    onChangeName() {
        this.apiService.changeUserData(this.username, { name: this.name }).subscribe((data) => {
            if (data.success) {
    ...
    onChangeUsername() {
        ...
        this.apiService.changeUserData(this.username, { username: this.edited_username }).subscribe((data) => {
            if (data.success) {
    ...
    onChangeEmail() {
        this.apiService.changeUserData(this.username, { email: this.email }).subscribe((data) => {
            if (data.success) {
                this.validationSuccess = true;
                this.validationError = false;
                this.validationSuccessMessage = data.msg;
    ...
    onChangePermissions() {
        this.apiService.changeUserData(this.username, { role: this.role }).subscribe((data) => {
            if (data.success) {
                this.validationSuccess = true;
                this.validationError = false;
                this.validationSuccessMessage = data.msg;
...
let ApiService = class ApiService {
    ...
    deleteFollower(username) {
        ...
        return this.http.delete(`${this.API_URL + "follower"}?username=${username}`, authenticationHeaders).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => res));
    }
...
module.exports = __webpack_require__(/*! /home/andrepascoa/github/twitter_clone/angular-src/src/main.ts */"./src/main.ts");
